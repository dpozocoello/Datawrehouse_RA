# Diccionario de Datos: DWH Regularización Ambiental

Este documento detalla la estructura técnica de las tablas en los esquemas `dw` y `stg`.


## Tabla: stg.consolidado_proyectos

| Columna | Tipo de Dato | Nulable |
| :--- | :--- | :--- |
