...
def verificar_conteos(conn_params: dict) -> dict:
    ...
    tablas = [
        ...
        # Staging — Pagos
        "stg.online_payments_bi", "stg.financial_transaction_bi",
        "stg.online_payments_historical_bi",
        # Staging — Waste/Chemical (v1.5)
        "stg.stg_waste_generator", "stg.stg_waste_type",
        "stg.stg_fact_waste_generation", "stg.stg_chemical_substance",
        # Staging — Chemical Imports (v1.5)
        "stg.stg_chemical_sustances_records", "stg.stg_import_request",
        "stg.stg_chemical_substances_declaration",
        "stg.stg_chemical_substances_movements", "stg.stg_project_mapping",
        # Staging — Pesticides (v1.5)
        "stg.stg_pesticide_project", "stg.stg_products_pqa",
        "stg.stg_detail_pesticide_project",
        # Staging — Intersecciones (v1.9)
        "stg.stg_intersection",
        # Dimensiones — Core
        ...
        "dw.dim_area", "dw.dim_pago",
        # Dimensiones — Waste/Chemical (v1.5)
        "dw.dim_waste_type", "dw.dim_chemical_substance",
        # Dimensiones — Intersecciones (v1.9)
        "dw.dim_intersection",
        # Hechos — Core
        "dw.fact_regularizacion", "dw.fact_pago", "dw.fact_proyecto_geografia",
        # Hechos — Waste/Chemical (v1.5)
