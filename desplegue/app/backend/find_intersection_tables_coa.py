...
def find_intersection_tables():
    query = text("SELECT table_name FROM information_schema.tables WHERE table_schema = 'coa_mae' AND table_name ILIKE '%intersec%'")
    try:
