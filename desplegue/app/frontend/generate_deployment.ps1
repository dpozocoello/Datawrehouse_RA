# generate_deployment.ps1
# Script para generar el paquete de despliegue del Dashboard ECO-SIEAA
...
$distDir = "desplegue"
$zipFile = "DashboardRA_Desplegue_$(Get-Date -Format 'yyyyMMdd_HHmm').zip"

Write-Host "==========================================================" -ForegroundColor Cyan
Write-Host "   GENERADOR DE DESPLIEGUE ECO-SIEAA v1.01" -ForegroundColor Cyan
Write-Host "==========================================================" -ForegroundColor Cyan

# 1. Limpiar/Crear carpeta de despliegue
if (Test-Path $distDir) {
    Write-Host "[1/6] Limpiando carpeta de despliegue existente..."
...
# 5. Comprimir paquete
Write-Host "[5/6] Comprimiendo paquete de despliegue..."
