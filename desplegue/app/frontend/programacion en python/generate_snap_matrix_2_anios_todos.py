...
def generate_matrix():
    ...
    print("\n2. Conectando a la base local (area_stage_saf_suia) para obtener todos los proyectos de los ultimos 2 años...")
    ...
    WHERE "FECHA REGISTRO" >= CURRENT_DATE - INTERVAL '2 years'
    """
    
    df_bi = pd.read_sql(q_bi, conn_local)
    conn_local.close()

    print(f"   -> Encontrados {len(df_bi)} proyectos de todos los estados en los ultimos 2 años.")
    ...
    output_file = 'matriz_regularizacion_ambiental_todos_estados_snap_ultimos_2_anios.xlsx'
