...
COMMENT ON MATERIALIZED VIEW dw.mv_dashboard_regularizacion IS 'Vista materializada optimizada para el dashboard de Looker Studio';
COMMENT ON VIEW dw.v_dashboard_regularizacion IS 'Vista consolidada para el tablero de control de Regularizacion Ambiental en Looker Studio';