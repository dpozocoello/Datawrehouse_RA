...
def audit_snap_layers():
    try:
        ...
        target_id = 542234
        print(f"\nChecking intersections for Project {target_id} in coa_mae.intersections_project_licencing_coa...")
        cur.execute("""
