...
-- Sentinel sk_area=0: eliminar si existe con sk_area incorrecto, luego insertar con sk_area=0 explícito
DELETE FROM dw.dim_area WHERE id_area = 0 AND sk_area != 0;
INSERT INTO dw.dim_area (sk_area, id_area, nombre_area, estado_area, provincia, canton, parroquia)
VALUES (0, 0, 'AREA NO DEFINIDA', 'N/A', 'N/A', 'N/A', 'N/A')
