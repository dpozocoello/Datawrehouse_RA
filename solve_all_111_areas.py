...
def solve_all_111_areas():
    try:
        ...
        # Load ALL areas with NULL gelo_id from Staging
        query = """
            SELECT area_id, area_name, area_campus, zone_id, area_abbreviation, area_description
        ...
        for _, area in df_all.iterrows():
            ...
            desc = normalize_text(str(area['area_description']))
            fullname = f"{name} {campus} {abbr} {desc}"
