# 📖 Diccionario Técnico de Datos: DRE Regularización Ambiental (v1.5)

Este documento detalla la estructura técnica exhaustiva de los esquemas `dw` y `stg` del Data Warehouse.

## 1. Relación de Capas
- **Esquema `stg`**: Capa de aterrizaje de datos transaccionales.
- **Esquema `dw`**: Capa dimensional (Star Schema) para analítica.
