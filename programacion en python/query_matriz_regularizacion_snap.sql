-- SQL para generar la Matriz de Regularización Ambiental (Completados) con Intersección SNAP
...
WHERE main."ESTADO PROCESO" = 'Completado'
    AND main."FECHA REGISTRO" >= CURRENT_DATE - INTERVAL '10 years';
