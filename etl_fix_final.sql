-- Script de reparacion final: ampliar tipos de datos y reindexar
-- Ejecutar: psql -U postgres -d dw_reg_v1 -f etl_fix_final.sql
-- ==============================================================================
-- PASO 0: Arreglar columnas VARCHAR(255) que son demasiado cortas
-- ==============================================================================
ALTER TABLE stg.jbpm_sector_bi
ALTER COLUMN codigo_actividad TYPE TEXT;
ALTER TABLE stg.jbpm_sector_bi
ALTER COLUMN actividad_economica TYPE TEXT;
ALTER TABLE stg.jbpm_sector_bi
ALTER COLUMN codigo_proyecto TYPE TEXT;
ALTER TABLE stg.jbpm_sector_bi
ALTER COLUMN ced_ruc_proponente TYPE TEXT;
ALTER TABLE stg.jbpm_sector_bi
ALTER COLUMN tipo_sector TYPE TEXT;
ALTER TABLE stg.jbpm_sector_bi
ALTER COLUMN canton TYPE TEXT;
ALTER TABLE stg.jbpm_sector_bi
ALTER COLUMN parroquia TYPE TEXT;
ALTER TABLE stg.jbpm_sector_bi
ALTER COLUMN tarea TYPE TEXT;
ALTER TABLE stg.jbpm_sector_bi
ALTER COLUMN usuario_tarea TYPE TEXT;
ALTER TABLE stg.jbpm_sector_bi
ALTER COLUMN estado_proyecto TYPE TEXT;
...
ALTER COLUMN tipo_sector TYPE TEXT;
ALTER TABLE stg.jbpm_4cat_bi
ALTER COLUMN tipo_permiso_ambiental TYPE TEXT;
ALTER TABLE stg.jbpm_4cat_bi
ALTER COLUMN canton TYPE TEXT;
ALTER TABLE stg.jbpm_4cat_bi
ALTER COLUMN parroquia TYPE TEXT;
ALTER TABLE stg.jbpm_4cat_bi
ALTER COLUMN proceso TYPE TEXT;
ALTER TABLE stg.jbpm_4cat_bi
ALTER COLUMN tarea TYPE TEXT;
ALTER TABLE stg.jbpm_4cat_bi
ALTER COLUMN usuario_tarea TYPE TEXT;
ALTER TABLE stg.jbpm_4cat_bi
ALTER COLUMN estado_tramite TYPE TEXT;
ALTER TABLE stg.jbpm_4cat_bi
ALTER COLUMN estrategico TYPE TEXT;
ALTER TABLE stg.jbpm_4cat_bi
ALTER COLUMN direccion_proyecto TYPE TEXT;
-- Eliminar indice problematico en fact (TEXT no soporta btree grande)
DROP INDEX IF EXISTS dw.idx_fact_snap;
-- ==============================================================================
...
-- ==============================================================================
-- PASO 3: Re-consolidar staging (con TODOS los origenes)
-- ==============================================================================
SELECT dw.sp_consolidar_staging();
-- ==============================================================================
-- PASO 4: Re-cargar dimensiones
-- ==============================================================================
...
FROM dw.dim_tiempo
ORDER BY 1;
SELECT '====== FACT TABLE ======' AS seccion;
SELECT COUNT(1) AS total_hechos
